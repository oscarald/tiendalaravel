    ...
    export default {
        ...
        methods : {
            ...
            selectCliente(search,loading){
                ...
                var url= '/persona/selectCliente?filtro='+search;
                axios.get(url).then(function (response) {
            ...
            pdfVenta(id){
                window.open('http://vuelaravel.test/venta/pdf/'+ id + ',' + '_blank');
            },
            ...
            registrarVenta(){
                ...
                axios.post('/venta/registrar',{
                    ...
                    me.descuento=0;
                    me.arrayDetalle=[];
                    window.open('http://vuelaravel.test/venta/pdf/'+ response.data.id + ',' + '_blank');
