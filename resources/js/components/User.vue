                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar" @keyup.enter="listarPersona(1,buscar,criterio)" class="form-control" placeholder="Busque de acuerdo al nombre, número de documento, direccíon, télefono o email">
...
<script>
    export default {
        ...
        methods : {
            ...
            async listarPersona(page,buscar){
                let me=this;
            ...
            async actualizarPersona(){
                ...
                let me =this;
                await axios.put('/user/actualizar',{
                    'nombre': this.nombre,
                    'tipo_documento': this.tipo_documento,
                    'num_documento': this.num_documento,
                    'direccion': this.direccion,
            ...
            getResults(page = 1) {
			axios.get('/proveedor?page=' + page)
				.then(response => {
					this.arrayPersona = response.data;
				});
		    },
