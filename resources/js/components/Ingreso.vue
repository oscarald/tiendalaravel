                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarIngreso(1,buscar,criterio)" class="form-control" placeholder="Busque de acuerdo al tipo de comprobante número de comprobante o fecha y hora">
            ...
            async desactivarIngreso(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/ingreso/desactivar',{
                        ...
                        Swal.fire(
                            'Anulado!',
                            'El Ingreso se ha anulado con éxito',
                            'success'
                        )
                    }).catch(function (error){
                        console.log(error);
