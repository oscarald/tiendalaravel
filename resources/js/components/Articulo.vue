                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="codigo" class="form-control" placeholder="Código de artículo">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input v-model="descripcion" class="form-control" placeholder="Descripción">
                                </div>
                            </div>
...
<script>
    export default {
        ...
        methods : {
            ...
            cargarPdf(){
                window.open('http://vuelaravel.test/articulo/listarPdf','_blank');
            },
            ...
            validarArticulo(){
                ...
                if(!this.stock) this.errorMostrarMsjArticulo.push("El stock de los artículos tiene que ser un número y no puede estar vacío");
                if(!this.precio_venta) this.errorMostrarMsjArticulo.push("El precio de venta de los artículos tiene que ser un número y no puede estar vacío");
            ...
            async desactivarArticulo(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/articulo/desactivar',{
                        ...
                        Swal.fire(
                            'Desactivado!',
                            'El artículo se ha desactivado con éxito',
                            'success'
                        )
                    }).catch(function (error){
                        console.log(error);
            ...
            async activarArticulo(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/articulo/activar',{
                        ...
                        Swal.fire(
                            'Activado!',
                            'El artículo se ha activado con éxito',
                            'success'
                        )
                    }).catch(function (error){
                        console.log(error);
