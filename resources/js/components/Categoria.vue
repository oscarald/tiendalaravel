                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar" @keyup="listarCategoria(1,buscar)" class="form-control" placeholder="Introduzca al nombre de la categoría o la descripción">
...
<script>
    export default {
        ...
        methods : {
            ...
            async listarCategoria(page,buscar){
                let me=this;
